...
@implementation FcodeViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([model.block_type isEqualToString:@"1"]) {
        ...
        [index1Service caseInfoWithLessonId:model.lesson_id andMid:user.mid andSecret:user.secret withViewController:self withDone:^(CaseInfoModelInfo *models){
